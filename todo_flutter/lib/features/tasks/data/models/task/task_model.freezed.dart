...
@override
String toString() {
  return 'TaskModel(id: $id, userId: $userId, customerId: $customerId, createdAt: $createdAt, lastModified: $lastModified, isDeleted: $isDeleted, title: $title, categoryId: $categoryId)';
}
...
class _TaskModel implements TaskModel {
  const _TaskModel({required this.id, required this.userId, required this.customerId, required this.createdAt, required this.lastModified, this.isDeleted = false, required this.title, this.categoryId});
