...
@override
String toString() {
  return 'ConfigurationModel(id: $id, userId: $userId, customerId: $customerId, createdAt: $createdAt, lastModified: $lastModified, isDeleted: $isDeleted, group: $group, key: $key, value: $value)';
}
...
class _ConfigurationModel implements ConfigurationModel {
  const _ConfigurationModel({required this.id, required this.userId, required this.customerId, required this.createdAt, required this.lastModified, this.isDeleted = false, required this.group, required this.key, required this.value});
